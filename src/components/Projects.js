...
return (
        <div>
            ...
            <p className='text-md text-[#C4C4C4] text-center mt-4'>As a firm believer in continuous learning, I stay up-to-date with the latest advancements in web technologies.</p>
